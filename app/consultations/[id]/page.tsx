...
const MOCK_QUESTIONS_DB = [
  {
    ...
    description: "تم فصلي من عملي دون سابق إنذار بعد 5 سنوات من الخدمة في شركة خاصة. لم أحصل على أي تحذيرات مسبقة ولم يتم إخطاري بأسباب واضحة للفصل. كنت أعمل كمدير مبيعات وكان أدائي جيداً حسب التقييمات السنوية. \n\nأريد معرفة: \n1. هل يحق لي الحصول على تعويض؟\n2. ما هي المدة القانونية للإخطار المسبق؟\n3. هل يمكنني رفع دعوى قضائية؟\n4. ما هي الوثائق التي يجب أن أجمعها؟",
...
export default async function ConsultationDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const MOCK_QUESTION = MOCK_QUESTIONS_DB.find((q) => q.id === questionId) || MOCK_QUESTIONS_DB[0];
